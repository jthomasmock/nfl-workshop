---
title: "Intro to `tidymodels` with `nflfastR` play-by-play"
...
Along the way, we'll cover minimal examples and then some more quick best practices
...
QBR = ESPN's Quarterback Rating, which ranges from 0 - 100.
...
knitr::include_graphics("qbr_win_tab.png")
```
...
Generally:  
* Reshaping or basic cleaning - do in `tidyverse`  
* Statistical transformations or other things that are intended for modeling  
...
`tidymodels` *really* shines when you start to apply additional best practices like:  
